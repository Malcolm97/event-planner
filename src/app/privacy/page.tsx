    ...
    <div className="min-h-screen bg-white flex flex-col justify-between">
      <div className="py-16 px-4 sm:px-8">
        <div className="max-w-4xl mx-auto">
          <h1 className="page-title text-gray-900 mb-8">Privacy Policy</h1>
          ...
          <div className="space-y-8">
            ...
            <section>
              <h2 className="section-title text-gray-900 mb-4">3. Information Sharing and Disclosure</h2>
              <div className="space-y-4">
            ...
            <section>
              <h2 className="section-title text-gray-900 mb-4">5. Your Rights and Choices</h2>
              <div className="space-y-4">
            ...
            <section>
              <h2 className="section-title text-gray-900 mb-4">6. Data Retention</h2>
              <div className="space-y-4">
            ...
            <section>
              <h2 className="section-title text-gray-900 mb-4">7. International Data Transfers</h2>
              <p className="text-gray-700 mb-4">
            ...
            <section>
              <h2 className="section-title text-gray-900 mb-4">8. Children's Privacy</h2>
              <p className="text-gray-700 mb-4">
            ...
            <section>
              <h2 className="section-title text-gray-900 mb-4">9. Changes to This Privacy Policy</h2>
              <p className="text-gray-700 mb-4">
            ...
            <section>
              <h2 className="section-title text-gray-900 mb-4">10. Contact Us</h2>
              <p className="text-gray-700 mb-4">
