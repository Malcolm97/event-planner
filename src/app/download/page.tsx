    ...
    <div className="min-h-screen bg-white flex flex-col justify-between">
      <div className="py-16 px-4 sm:px-8">
        <div className="max-w-3xl mx-auto">
          <h1 className="page-title text-gray-900 mb-8">Install PNG Events</h1>
          ...
          <div className="bg-gradient-to-r from-yellow-400 to-yellow-500 rounded-lg p-6 mb-8 text-center">
            <h2 className="page-title text-white mb-4">Install Now - It's Free!</h2>
          ...
          <div className="mb-8">
            <h2 className="section-title text-gray-900 mb-4">iPhone & iPad (iOS)</h2>
          ...
          <div className="mb-8">
            <h2 className="section-title text-gray-900 mb-4">Android Phones</h2>
            <ol className="list-decimal pl-6 text-gray-700 mb-4">
