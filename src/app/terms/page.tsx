    ...
    <div className="min-h-screen bg-white flex flex-col justify-between">
      <div className="py-16 px-4 sm:px-8">
        <div className="max-w-4xl mx-auto">
          <h1 className="page-title text-gray-900 mb-8">Terms of Service</h1>
          ...
          <div className="space-y-8">
            ...
            <section>
              <h2 className="section-title text-gray-900 mb-4">2. Description of Service</h2>
              <p className="text-gray-700 mb-4">
            ...
            <section>
              <h2 className="section-title text-gray-900 mb-4">3. User Accounts and Registration</h2>
            ...
            <section>
              <h2 className="section-title text-gray-900 mb-4">4. Progressive Web App (PWA) Usage</h2>
              <div className="space-y-4">
            ...
            <section>
              <h2 className="section-title text-gray-900 mb-4">5. Push Notifications</h2>
              <div className="space-y-4">
            ...
            <section>
              <h2 className="section-title text-gray-900 mb-4">6. Event Creation and Management</h2>
              <div className="space-y-4">
            ...
            <section>
              <h2 className="section-title text-gray-900 mb-4">7. User Conduct and Prohibited Activities</h2>
              <div className="space-y-4">
            ...
            <section>
              <h2 className="section-title text-gray-900 mb-4">8. Intellectual Property Rights</h2>
              <div className="space-y-4">
            ...
            <section>
              <h2 className="section-title text-gray-900 mb-4">9. Privacy and Data Protection</h2>
              <p className="text-gray-700 mb-4">
            ...
            <section>
              <h2 className="section-title text-gray-900 mb-4">10. Service Availability and Disclaimers</h2>
              <div className="space-y-4">
            ...
            <section>
              <h2 className="section-title text-gray-900 mb-4">11. Limitation of Liability</h2>
              <p className="text-gray-700 mb-4">
            ...
            <section>
              <h2 className="section-title text-gray-900 mb-4">12. Account Termination</h2>
              <div className="space-y-4">
            ...
            <section>
              <h2 className="section-title text-gray-900 mb-4">13. Changes to Terms</h2>
              <p className="text-gray-700 mb-4">
            ...
            <section>
              <h2 className="section-title text-gray-900 mb-4">14. Governing Law</h2>
              <p className="text-gray-700">
            ...
            <section>
              <h2 className="section-title text-gray-900 mb-4">15. Contact Information</h2>
              <p className="text-gray-700 mb-4">
